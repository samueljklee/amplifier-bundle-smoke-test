...
```python
task(
    agent="smoke-test:smoke-tester",
    instruction="Run full smoke tests"
)
```
...
### @Mention Validation Fails

Common causes:
- Fixture files not in bundle cache
- File read permissions
- Provider not following instructions

The fixture files should be at:
- `~/.amplifier/cache/*smoke-test*/fixtures/test_doc1.md`
- `~/.amplifier/cache/*smoke-test*/fixtures/test_doc2.md`
